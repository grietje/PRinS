...
S1test = list(cursor.execute("select Node,Destype,Role,Name,Nr,ClANr,PhANr from pt where not Nr is NULL and not Nr = '' and not Nr = 1 order by Name,Nr"))
Destypes_S = {}
Destypes_N = {}
Names = {}
Name_prev = ""
...
#    and (Nr_now-Nr_prev) == 1 
        ...
        if Role_now == "Subj":
            if Destype in Destypes_S:
                Destypes_S[Destype] += 1
            else:
                Destypes_S[Destype] = 1
        else:
            if Destype in Destypes_N:
                Destypes_N[Destype] += 1
            else:
                Destypes_N[Destype] = 1
            if Role in Roles:
                Roles[Role] += 1
