...
\subitem Relevant data: number of references to this referent in the current chapter, distance to previous reference, number of interceding referents (with competing grammatical features), encoding level of previous references
...
\subitem Relevant data: Role in sentence, Sub-data, Clause\_type
...
\subitem Relevant data: Clause\_type, type of verb used in the clause
...
\subitem Relevant data: person, number and gender, both of current reference and surrounding references, activation state, number of other referents and their activation state
\end{itemize}
