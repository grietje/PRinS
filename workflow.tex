...
#        for l in options:
            if F.etcbc4_db_otype.v(k) == "subphrase" and F.etcbc4_ft_rela.v(k) == "rec":
                ...
                for x in C.mother.v(k):
                    REG = x
                print("\nREG: ",F.etcbc4_ft_g_cons.v(REG)," rectum: ",get_cons_of_word_list(give_me_your_words(k)))
            elif F.etcbc4_db_otype.v(k) == "subphrase" and F.etcbc4_ft_rela.v(k) == "atr":
                ATTR = ""
                for y in C.mother.v(k):
                    ATTR = y
                print("\nATTR: ",get_cons_of_word_list(give_me_your_words(ATTR))," attr: ", get_cons_of_word_list(give_me_your_words(k)))
        Data["a"] = place
        Data["Node"] = node
