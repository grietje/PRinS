...
\item Value \mi{RecPro} for sub-participants who precede the \mi{Sub1} sub-participant, and having an identity different from the reference they are part of (in other words, this is a \mi{Rec}sub-participant that does not follow but precede its \mi{parent}.) The typical example here is \hebr{KL}.
...
\hspace{1ex} \mi{Sub1 Super} \> \hebr{<Y PRJ \cl{white}{<FH PRJ L MNJW >CR ZR<W BW}} \\
\hspace{2ex} \mi{Sub1 Sub1} \> \hebr{<Y \cl{white}{PRJ <FH PRJ L MNJW >CR ZR<W BW}}\\
\hspace{2ex} \mi{Sub1 Rec} \> \hebr{\cl{white}{<Y} PRJ \cl{white}{<FH PRJ L MNJW >CR ZR<W BW}}\\
\hspace{1ex} \mi{Attr Super} \> \hebr{\cl{white}{<Y PRJ} <FH PRJ L MNJW >CR ZR<W BW} \\
\hspace{2ex} \mi{Attr Sub1} \> \hebr{\cl{white}{<Y PRJ} <FH \cl{white}{PRJ L MNJW >CR ZR<W BW}} \\
\hspace{2ex} \mi{Attr Rec Super} \> \hebr{\cl{white}{<Y PRJ <FH} PRJ L MNJW >CR ZR<W BW} \\
\hspace{3ex} \mi{Attr Rec Sub1} \> \hebr{\cl{white}{<Y PRJ <FH} PRJ \cl{white}{L MNJW >CR ZR<W BW}} \\
\hspace{3ex} \mi{Attr Rec Attr Super1} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L} MNJW \cl{white}{>CR ZR<W BW}} \\
\hspace{4ex} \mi{Attr Rec Attr Rec} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L MNJ}W \cl{white}{>CR ZR<W BW}} \\
\hspace{3ex} \mi{Attr Rec Attr Super} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L MNJW} >CR ZR<W BW} \\
\hspace{4ex} \mi{Attr Rec Attr Super1} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L MNJW >CR} ZR<W \cl{white}{BW}} \\
\hspace{5ex} \mi{Attr Rec Attr Rec} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L MNJW >CR ZR<}W \cl{white}{BW} \\
\hspace{4ex} \mi{Attr Rec Attr Rec} \> \hebr{\cl{white}{<Y PRJ <FH PRJ L MNJW >CR ZR<W B}W} \\
\end{tabbing}
...
\item With a suffix: \bibleverse{Gen}(2:17) \\ \hebr{B JWM \cl{red}{>KLK} MMNW MWT TMWT} \\``... in the day that you eat of it, you will surely die.''
...
%sagemathcloud={"latex_command":"pdflatex -synctex=1 -shell-escape -interact=nonstopmode 'Encoding.tex'"}
