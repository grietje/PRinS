...
\item With a demonstrative pronoun: \bibleverse{Gen}(21:10) \\ \hebr{GRC H >MH \cl{red}{H Z>T} W >T BNH} \\ ``Cast out this servant and her son!'' \footnote{Found as `rec', but annotated with `dem'}
...
\item With an interrogative pronoun: \footnote{Found as status constructus followed by `prin'; not indicated by `rec'} \bibleverse{Gen}(24:23) \\ \hebr{BT \cl{red}{MJ} >T} \\ ``Whose daughter are you?''
