...
\begin{figure}
\input{plots/Destypes_of_Subjects_Speech_OT.pgf}
\caption{Subject references}
\end{figure}
\begin{figure}
\input{plots/Destypes_of_Subjects_Narrative_OT.pgf}
\caption{Subject references}
\end{figure}
...
\begin{figure}
\input{plots/Destypes_of_Objects_Speech_OT.pgf}
\caption{Destypes of objects}
\end{figure}
\begin{figure}
\input{plots/Destypes_of_Objects_Narrative_OT.pgf}
\caption{Destypes of objects}
\end{figure}
...
\begin{figure}
\input{plots/Destypes_of_Prep_Narrative_OT.pgf}
\caption{References after prepositions}
\end{figure}
\begin{figure}
\input{plots/Destypes_of_Prep_Speech_OT.pgf}
\caption{References after prepositions}
\end{figure}
...
Statistics of these references:
\begin{figure}
\input{plots/Destypes_of_>T_Narrative_OT.pgf}
\caption{Object references with \hebr{>T}}
\end{figure}
\begin{figure}
\input{plots/Destypes_of_>T_Speech_OT.pgf}
\caption{Object references with \hebr{>T}}
\end{figure}
