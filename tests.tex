...
tex = barplot((nar3.fillna(0)),"plots/Destypes_of_Subjects_Narrative_Nar.tex")

speech = DataFrame(speech_data).transpose()
speech2 = speech['destype'].value_counts()
speech3 = Series(speech2,index=["verb","ptca","suffix","personal_pronoun","demonstr_pronoun","adjective","ptcp","noun","phrase","name","name_phrase"])
speech3.index.name = "Destypes of Subjects in Direct Speech in Narrative Books"
tex = barplot((speech3.fillna(0)),"plots/Destypes_of_Subjects_Speech_Nar.tex")
