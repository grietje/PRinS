...
\paragraph{\mi{Regens-rectum relation}}
Sub-participants annotated with the \mi{rectum} part of the \mi{Regens-rectum relation} are, as have seen above, not directly dependent on the grammatical context beyond the word that reigns them. We therefore consider words annotated as \mi{Regens} as a separate category of introduction, followed by an alternative `slot'. \\
Since this relationship only occurs on words, it is not assigned to suffixes. However, I think there are suffixes fulfilling a comparable function:
...
\item With a demonstrative pronoun: \bibleverse{Gen}(21:10) \\ ``Cast out this servant and her son! For the son of this servant will not be heir with my son, Isaac'' \textbf{Found as `rec', but annotated with `dem'}
%\item With an interrogative pronoun: \bibleverse{Gen}
\item With a verb (participle): \bibleverse{Gen}
...
\item With an adjective: \bibleverse{Gen}
\item With a phrase (multiple words): \bibleverse{Gen}
\end{itemize}
...
\textbf{Demonstrative pronoun} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Interrogative pronoun} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Verb (participle)} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Noun} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Personal noun} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Adjective} & Yes & Yes & Yes & Yes & \\ \hline
\textbf{Phrase} & Yes & Yes & Yes & Yes & \\ \hline
\end{tabularx}
