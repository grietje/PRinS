...
Nodetype & Type of node: 1=part\_suffix, 2=part\_word, 3=part\_phrase, 4=part\_clause, 5=part\_sentence & Part-1.py input\\ \hline
...
Sub & ``Yes'' if sub-participant, else ``No'' \\ \hline
