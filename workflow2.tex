...
#        print("clan_member under attention is: ",candidate)
        ...
        print("{0!s: <9} {1!s: <15} {2!s: <40}".format(data[candidate]["Node"], data[candidate]["Sub"], get_cons_of_word_list(give_me_your_words(candidate))))
...
#    print("Start of second for-loop")
    for candidate in clan_members2:
        print("clan_members is: ", clan_members, "clan_members2 is: ", clan_members2)
        for x in ["Nodetype","Destype","Name","Anim","Human","Col"]:
