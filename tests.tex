...
nar3.plot(kind="bar",title="Narrative")
plt.savefig("plots/Destypes_of_Prep_Narrative_OT.pgf", bbox_inches="tight")
...
speech3.plot(kind="bar",title="Direct Speech")
plt.savefig("plots/Destypes_of_Prep_Speech_OT.pgf", bbox_inches="tight")
...
nar3 = Series(nar2,index = ["verb","ptca","suffix","personal_pronoun","demonstr_pronoun","adjective","ptcp","noun","phrase","name","name_phrase"])
nar3.plot(kind="bar",title="Narrative")
#plt.savefig("plots/Destypes_of_Objects_Narrative_OT.pgf", bbox_inches="tight")
plt.savefig("plots/Destypes_of_>T_Narrative_OT.pgf", bbox_inches="tight")

speech = DataFrame(speech_data).transpose()
speech2 = speech['destype'].value_counts()
speech3 = Series(speech2,index=["verb","ptca","suffix","personal_pronoun","demonstr_pronoun","adjective","ptcp","noun","phrase","name","name_phrase"])
speech3.plot(kind="bar",title="Direct Speech")
#plt.savefig("plots/Destypes_of_Objects_Speech_OT.pgf", bbox_inches="tight")
plt.savefig("plots/Destypes_of_>T_Speech_OT.pgf", bbox_inches="tight")
...
nar3 = Series(nar2,index = ["verb","ptca","suffix","personal_pronoun","demonstr_pronoun","adjective","ptcp","noun","phrase","name","name_phrase"])
nar3.plot(kind="bar",title="Narrative")
plt.savefig("plots/Destypes_of_Subjects_Narrative_OT.pgf", bbox_inches="tight")

speech = DataFrame(speech_data).transpose()
speech2 = speech['destype'].value_counts()
speech3 = Series(speech2,index=["verb","ptca","suffix","personal_pronoun","demonstr_pronoun","adjective","ptcp","noun","phrase","name","name_phrase"])
speech3.plot(kind="bar",title="Direct Speech")
plt.savefig("plots/Destypes_of_Subjects_Speech_OT.pgf", bbox_inches="tight")
